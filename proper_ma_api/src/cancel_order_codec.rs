...
pub mod encoder {
    ...
    impl<'a> Writer<'a> for CancelOrderEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for CancelOrderEncoder<'a> {
        #[inline]
...
pub mod decoder {
    ...
    impl<'a> Reader<'a> for CancelOrderDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for CancelOrderDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
